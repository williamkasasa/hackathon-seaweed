...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'footer.about': 'About Seaweed & Co',
    'footer.aboutText': 'Brussels-based purveyor of premium sea vegetables, est. 2025',
  ...
  fr: {
    ...
    'footer.about': 'À Propos de Seaweed & Co',
    'footer.aboutText': 'Fournisseur de légumes de mer premium basé à Bruxelles, fondé en 2025',
    'footer.contact': 'Contact',
    'footer.email': 'Email',
  ...
  nl: {
    ...
    'footer.about': 'Over Seaweed & Co',
    'footer.aboutText': 'Brusselse leverancier van premium zeegroenten, opgericht in 2025',
    'footer.contact': 'Contact',
    'footer.email': 'Email',
